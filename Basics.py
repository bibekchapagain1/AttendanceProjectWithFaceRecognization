...
imgBibek = face_recognition.load_image_file('ImagesBasic/Bibek Chapagain.png')
imgBibek = cv2.cvtColor(imgBibek, cv2.COLOR_BGR2RGB)
imgTest = face_recognition.load_image_file('ImagesBasic/Bibek Test.JPG')
...
faceDis = face_recognition.face_distance([encodeBibek], encodeTest)
print(results, faceDis)
cv2.putText(imgTest, f'{results} {round(faceDis[0], 2)}', (50, 50), cv2.FONT_HERSHEY_COMPLEX, 1, (0, 0, 255), 2)

cv2.imshow('Bibek Chapagain', imgBibek)
